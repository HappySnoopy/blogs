...
public class RedisLocker implements DistributedLocker {
    ...
    public <T> T lock(String resourceName, AquiredLockWorker<T> worker)
            throws InterruptedException, UnableToAquireLockException,
            Exception {
    ...
    public <T> T lock(String resourceName, AquiredLockWorker<T> worker,
        ...
        RedissonClient redisson = this.redissonConnector.getClient();
        RLock lock = redisson.getLock(RedisLocker.LOCKER_PREFIX + resourceName);
